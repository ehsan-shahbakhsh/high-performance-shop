...
use Filament\Support\{Enums\TextSize, Icons\Heroicon};
use Filament\Tables\{Table, Columns\TextColumn, Filters\TernaryFilter};
...
class FilesRelationManager extends RelationManager
{
    ...
    {
        return $ownerRecord->type === ProductType::Simple && $ownerRecord->is_downloadable;
    }
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                Hidden::make('product_variant_id')->default($this->getOwnerRecord()->defaultVariant->id),
